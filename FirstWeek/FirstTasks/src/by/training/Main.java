...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Task_03: Triangle area: " + task3.calculateArea(5, 10));
        System.out.println("Task_03: Triangle perimeter: " + task3.calculatePeremiter(5, 10) + "\n");

        Task_04 task4 = new Task_04();
        System.out.println("Task_04: check range of coordinates: " + task4.check(-2, 0, new Rectangle(1, 1, 1, 1)) + "\n");

        Task_05 task5 = new Task_05();
        System.out.println("Task_05: pow2 if positive pow4 if negative: " + task5.calculate(-2));
        System.out.println("Task_05: pow2 if positive pow4 if negative:: " + task5.calculate(0));
        System.out.println("Task_05: pow2 if positive pow4 if negative:: " + task5.calculate(3) + "\n");

        Task_06 task6 = new Task_06();
        System.out.println("Task_06: sum of max and min: " + task6.calculateSum(-2, -4, 3) + "\n");
        ...
        System.out.println("Task_08: sum of multi: " + task8.calculateSum(2, 2, 4, 6, 3, 3, 3) + "\n");
